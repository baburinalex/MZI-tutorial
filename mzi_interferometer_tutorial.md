...
python mzi_tutorial.py     # построит все 6 рисунков в папку images/
```
...
4. Сделайте делитель неидеальным: разведите `split` двух ответвителей (понадобится доработать `mzi_transmission`). Что произойдёт с нулём на bar-выходе?
